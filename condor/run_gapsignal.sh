#!/bin/bash
# HTCondor worker wrapper for the E2 GAP-SIGNAL structure-test experiment.
#
...
#   3. exec's the gap-signal experiment module, passing through all condor args.
#
...
# --- run ------------------------------------------------------------------
echo "[wrapper] launching: python -u -m experiments.e2_discriminate_gapsignal $*"
exec python -u -m experiments.e2_discriminate_gapsignal "$@"
